  ...
  return (
    <div className={cn("space-y-8 pb-4", className)}>
      <div className="flex justify-between items-center">
        ...
        <p className="font-medium text-lg">{currencyFormatter.format(transaction?.amount / 100)}</p>
      </div>
      <div className="flex justify-between items-center">
...
export function TransactionDetailResponsive({ transaction, isOpen, setOpen }: { transaction?: Transaction, isOpen: boolean, setOpen: (v: boolean) => void }) {
